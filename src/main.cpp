...
//            cam = Camera(glm::vec3(278, 554, 279.5), glm::vec3(278, 553, 279.5), glm::vec3(1, 0, 0), 54);
...
//            auto blue_glass = std::make_shared<Lambertian>(std::make_shared<Solid>(Color(0.1373, .6745, .7686)));
            auto transparent = std::make_shared<Transparent>(std::make_shared<Solid>(Color(1, 1, 1)));
            ...
            hitlist.add(std::make_shared<Sphere<Transparent>>
                                (glm::vec3(350, 200, 100), 80, transparent, false));
